...
public class ToolBarBuilder {
    ...
    public JToolBar createToolBar(JFrame frame) {
        ...
        btnFormat.registerKeyboardAction(formatAction, KeyStroke.getKeyStroke(KeyEvent.VK_B, KeyEvent.CTRL_MASK), JComponent.WHEN_IN_FOCUSED_WINDOW);
        toolBar.addSeparator();
        toolBar.add(btnCompress = createButton(compressAction));
        btnCompress.registerKeyboardAction(compressAction, KeyStroke.getKeyStroke(KeyEvent.VK_L, KeyEvent.CTRL_MASK), JComponent.WHEN_IN_FOCUSED_WINDOW);
        toolBar.addSeparator();
        ...
        btnCopyCode.registerKeyboardAction(copyCodeAction, KeyStroke.getKeyStroke(KeyEvent.VK_C, KeyEvent.CTRL_MASK | KeyEvent.SHIFT_MASK), JComponent.WHEN_IN_FOCUSED_WINDOW);
        toolBar.addSeparator();
