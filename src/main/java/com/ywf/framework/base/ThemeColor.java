...
public final class ThemeColor {
    ...
    public static final Color themeColor = new Color(97,97,97,100);
    public static final Color fontColor = new Color(129, 212, 250, 100);
    ...
    public static final Color taskPaneHover = new Color(97,97,97,100);
